...
export const NoOutlinedButton = ({ children }) => {
  ...
  return (
   <button className="relative inline-flex items-center justify-center p-0 overflow-hidden text-m font-medium text-white rounded-lg group hover:text-white dark:text-white mx-4 " style={gradientStyle}>
