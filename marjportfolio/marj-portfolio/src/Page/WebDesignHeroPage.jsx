...
const WebDesignHeroPage = () => {
  return (
    <div className="bg-black">
      <div
        className="flex max-w-screen-lg flex-wrap justify-center items-center bg-cover bg-black bg-center mx-auto  font-plus jakarta sans "
        style={{ backgroundImage: `url(/images/bg1.webp)` }}
      >
        {/* Left Column */}
        <div className="w-1/2  pl-100">
          <div className="px-8">
          <h1 className="text-mh4 md:text-mh7 font-bold leading-none mb-8 text-white">
              Let's{" "}
              <span
                style={{
