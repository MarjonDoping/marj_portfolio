...
const CarouselPage = () => {
    ...
    <>
      ...
      >
        <div className="max-w-screen-xl mx-auto px-5">
          ...
          These works highlights represent just a glimpse of my capabilities and the diverse range of projects I've had the privilege to work on. If you're seeking a dedicated digital professional who can bring your vision to life and drive tangible results, I'm here to help.
          </p>
          ...
          <TECarousel showControls showIndicators ride="carousel">
            <div className="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
              ...
              >
                <img src="/images/cars.png" className="block w-full" alt="..." />
              </TECarouselItem>
              <TECarouselItem
                itemID={3}
                className="relative float-left hidden -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
              ...
              >
                <img src="/images/burger.png" className="block w-full" alt="..." />
              </TECarouselItem>
              <TECarouselItem
                itemID={5}
                className="relative float-left hidden -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
              ...
              >
                <img src="/images/bike.png" className="block w-full" alt="..." />
              </TECarouselItem>
              <TECarouselItem
                itemID={6}
                className="relative float-left hidden -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
              ...
              >
                <img src="/images/cozy.png" className="block w-full" alt="..." />
              </TECarouselItem>
      ...
      {modalOpen && (
        <div className="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-75 flex justify-center items-center z-50">
          <div ref={modalRef} className="bg-black p-4 rounded-lg max-w-screen-md overflow-auto h-full relative pt-10">
  ...
  <path opacity="0.5" d="M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" fill="white"/>
  <path d="M8.96967 8.96967C9.26256 8.67678 9.73744 8.67678 10.0303 8.96967L12 10.9394L13.9697 8.96969C14.2626 8.6768 14.7374 8.6768 15.0303 8.96969C15.3232 9.26258 15.3232 9.73746 15.0303 10.0304L13.0607 12L15.0303 13.9696C15.3232 14.2625 15.3232 14.7374 15.0303 15.0303C14.7374 15.3232 14.2625 15.3232 13.9696 15.0303L12 13.0607L10.0304 15.0303C9.73746 15.3232 9.26258 15.3232 8.96969 15.0303C8.6768 14.7374 8.6768 14.2626 8.96969 13.9697L10.9394 12L8.96967 10.0303C8.67678 9.73744 8.67678 9.26256 8.96967 8.96967Z" fill="white"/>
</svg>
            </button>
          </div>
        </div>
